...
/**
 * This class is used to represent the data from a line of an imported CSV data file. Each Data
 * object has a day, weight, and farm ID.
 */
public class FarmData {
   ...
   */
  public FarmData(int day, String farmID, int weight) {
    this.day = day;
    this.farmID = farmID;
    this.weight = weight;
  }
