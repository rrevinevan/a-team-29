...
public class Handler {
   ...
   * @return an ArrayList<Integer> representing all of the farm IDs in the passed year, month
   */
  ...
  /**
   * This method is used to obtain a list of all farmIDs involved in a date range period
   * 
   * @param d  - start day
   * @param m  - start month
   * @param y  - start year
  ...
  /**
   * This method is used to get the weight of a specific farm in a passed time period
   * 
   ...
   * @param m2     - end month
   * @param y2     - end year
   * @return An Integer representing the total weight of the passed farm in the time period
   */
   ...
   * @param m2 - end month
   * @param y2 - end year
   * @return an Integer representing the total weight of all farms in the time period
   */
  ...
  public void addFarmData(String farmID, int weight, int y, int m, int d) {
    ...
    // Modifying existing year
      ...
      // Add new data
      ds.get(dsGetIndex(y)).addData(m, d, farmID, weight);
    }
  }


  /**
   * This method is used to peek at a piece of data from the ds
   * 
   * @param farmID - The farm to be added
   * @param weight - The weight to be added
   * @param y      - the year it is to be added at
   ...
   * @param d      - the day it is to be added at
   */
  public int getFarmData(String farmID, int y, int m, int d) {
    return ds.get(dsGetIndex(y)).getWeight(m, d, farmID);
  }
}
